...
- Exercise-specific START, MOVE, and FORM instructions for every supported movement, basic torso-posture checks, and automatic session pause when required joints leave the frame.
